...
CREATE TABLE IF NOT EXISTS birthday (username VARCHAR(20) NOT NULL, userid VARCHAR(20) NOT NULL UNIQUE, date DATE NOT NULL, channelid NOT NULL, serverid NOT NULL);