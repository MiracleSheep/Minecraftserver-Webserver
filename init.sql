...
CREATE TABLE IF NOT EXISTS voting (username VARCHAR(20) NOT NULL, time TIME NOT NULL, date DATE NOT NULL, vote int NOT NULL, PRIMARY KEY(username), FOREIGN KEY(username) REFERENCES credentials(username));
